...
interface ILivenessRadius {
    ...
    function addRollup(string calldata clusterId, string calldata rollupId, string calldata chainType, address rollupOwnerAddress, string calldata orderCommitmentType, ValidationInfo calldata validationInfo) external;
    ...
    event InitializeCluster(string clusterId, address owner);
